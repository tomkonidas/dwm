...
static const char *fonts[]          = { "Fira Code:size=12", "monospace:pixelsize=10:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_x,		spawn,		SHCMD("~/bin/i3lock_blur") },
	...
	{ 0, XF86XK_ScreenSaver,	spawn,		SHCMD("~/bin/i3lock_blur") },
